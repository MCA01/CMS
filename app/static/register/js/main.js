...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var expertArea = document.getElementById('expertAreaRegister');

    function handleUserTypeChange() {
        if (this.value === "author") {
            expertArea.style.visibility = 'hidden';
            ...
            expertArea.style.visibility = 'visible';
        }
    }
    ...
    handleUserTypeChange.call(document.querySelector('input[name="user_type"]:checked'));
});
